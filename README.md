...
- 🙋‍♀️ **Have a question?**
  - **Chat with us now on [Discord](https://discord.gg/z8wNYzb)** or explore the [Troubleshooting Guide](https://docs.hugoblox.com/reference/troubleshooting/) and [Q&A Forum](https://github.com/chjwang1/hugo/discussions)
...
- ⬆️ **Updating?** View the [Update Guide](https://docs.hugoblox.com/reference/update/) and [Release Notes](https://github.com/chjwang1/hugo/releases)
- 🚀 [Contribute improvements](CONTRIBUTING.md) or [suggest improvements](https://github.com/chjwang1/hugo/issues)
...
The [Hugo Blox Builder](https://github.com/chjwang1/hugo/) repository is released under the [MIT](https://github.com/chjwang1/hugo/blob/main/LICENSE.md) license.
